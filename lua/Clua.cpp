...
void c_lua::initialize()
{
	...
	int i_read = GetPrivateProfileSectionA("autoload", i_buffer, 65536, "C:\\menu.ini");
...
//	username = szUsername;
//
//	crypt_str(beta222) = crypt_str(DownloadString(crypt_str("https://gamesense.ovh/forums/cloud/amm-get.php?lua_id=") + username));
//
//	if (crypt_str(beta222) == "0")
//		return;
//	std::stringstream geek(crypt_str(beta222));
//
//	for (const auto& entry : std::filesystem::directory_iterator(crypt_str("E:\\Program Files (x86)\\Steam\\steamapps\\common\\Counter-Strike Global Offensive\\luas\\cloud")))
...
//	geek >> c;
//	for (int i = 1; i < (c + 1); i++) {
//		beta = crypt_str(DownloadString(crypt_str("https://gamesense.ovh/forums/cloud/scripts-get.php?lua_id=") + crypt_str(username) + "&i=" + std::to_string(i)));
...
//		std::string beta2;
//		std::string beta3;
//		beta2 = crypt_str(DownloadString(crypt_str("https://gamesense.ovh/forums/cloud/cloud-get.php?lua_id=") + crypt_str(s))); //using my uid for testing purposes for now
//		beta3 = crypt_str(DownloadString(crypt_str("https://gamesense.ovh/forums/cloud/cloud2.php?lua_id=") + crypt_str(s))); //using my uid for testing purposes for now
//
