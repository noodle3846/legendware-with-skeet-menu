...
bool c_grenade_prediction::data_t::draw(entity_t* entity) const
{
	...
	render::get().circle_filled(prev_screen.x, prev_screen.y - size.y * 0.5f, 60, 20, Color(c_config::get()->c["grenproxcoll"][0], c_config::get()->c["grenproxcoll"][1], c_config::get()->c["grenproxcoll"][2], c_config::get()->c["grenproxcoll"][3]));
	//render::get().circle_filled(prev_screen.x, prev_screen.y - size.y * 0.5f, 60, 20, Color(c_config::get()->c["grenproxcoll2"][0], c_config::get()->c["grenproxcoll2"][1], c_config::get()->c["grenproxcoll2"][2], alpha_damage));
	draw_arc(prev_screen.x, prev_screen.y - size.y * 0.5f, 20, 0, 360 * percent, 2, Color(c_config::get()->c["grenproxcoll2"][0], c_config::get()->c["grenproxcoll2"][1], c_config::get()->c["grenproxcoll2"][2], c_config::get()->c["grenproxcoll2"][3]));
